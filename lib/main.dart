...
import 'package:tienda_02/screens/bebidas_screen.dart';
import 'package:tienda_02/screens/bebidas_form_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
        providers: [
          ChangeNotifierProvider(create: (_) => BebidasProvider()),
        ...
        child: MaterialApp(
          ...
          routes: {
            ...
            'bebidas': (_) => const BebidasScreen(),
            'bebidas_form': (_) => const BebidasFormScreen(),
